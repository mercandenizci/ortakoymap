...
class App extends Component {
  ...
  componentDidMount() {
    ...
    loadMapJS(
      "https://maps.googleapis.com/maps/api/js?libraries=geometry,drawing&key=AIzaSyBdHpuho-ppseX5rK16Wvoq2D7S7hM1Fbw&v=3&callback=initMap"
    );
  }
  ...
  initMap() {
    ...
    var map = new window.google.maps.Map(mapview, {
      center: { lat: 41.054030, lng: 29.028460 },
      zoom: 15,
